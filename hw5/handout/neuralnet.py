...
if __name__ == "__main__":
    ...
    trainRes = train(X_tr, y_tr, X_te, y_te, my_nn, all_te_mce, all_tr_mce)
    errorTr,TrLabels,errorTe,TeLabels = trainRes 
    #output metrics
    write_to_file(TrLabels, out_tr)
    write_to_file(TeLabels, out_te)
    write_to_metrics(errorTr, errorTe, all_tr_mce, all_te_mce, out_metrics)
